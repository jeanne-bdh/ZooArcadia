...
export const allRoutes = [
    ...
    new Route("/crudServEmpl", "Modifier les services", "/pages/employee/crud-services-empl.html", "/js/valid-crud-services.js"),
    new Route("/inputFoodConso", "Saisir la nourriture", "/pages/employee/input-food-conso.html", "/js/valid-food-conso.js"),
