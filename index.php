...
<main>
    ...
    <section class="container-habitats bg-secondary">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center">
                <img class="w-75" src="/assets/images/home/habitats/savane-home.jpg" alt="Habitats Savane">
                <a href="/pages/savane.php"><h4 class="text-black mt-1 mb-4">Savane</h4></a>
            </div>
            <div class="d-flex flex-column align-items-center">
                <img class="w-75" src="/assets/images/home/habitats/jungle-home.jpg" alt="Habitats Jungle">
                <a href="/pages/jungle.php"><h4 class="text-black mt-1 mb-4">Jungle</h4></a>
            </div>
            <div class="d-flex flex-column align-items-center">
                <img class="w-75 rounded-md-5" src="/assets/images/home/habitats/marais-home.jpg" alt="Habitats Marais">
    ...
    <!-- SECTION : AVIS -->
    <section class="text-center py-3 bg-info">
        <div class="container">
            ...
            <div class="row mt-4 mx-1">
                <div class="col-6 col-md-3">
                    ...
                    <p class="text-review">“Très très agréable comme zoo nous étions étonné que ce zoo soit aussi propre. Superbe découverte.”
                    </p>
                </div>
                <div class="col-6 col-md-3 d-none d-md-block">
                    ...
                    <p class="text-review">“Je suis allé dans ce zoo avec un enfant en bas âge en pensant y passer un bon moment. En réalité,
                        j’y ai
                ...
                <div class="col-6 col-md-3 d-none d-md-block">
                    ...
                    <p class="text-review">“Les explications du soigneur et de notre guide se sont révélées très utiles. L'activité est très
                        bien
                        organisée. Je recommande.”</p>
                </div>
                <div class="container-link-review col-6 col-md-3 d-flex flex-column justify-content-evenly">
            ...
            <a href="/listAvis"><button class="btn btn-black my-3">Plus d'avis</button></a>
        </div>
    </section>
