 ...
 */
class getVichUploader_Listener_Clean_AnimalService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.animal' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.animal'])) {
            return $container->privates['vich_uploader.listener.clean.animal'];
        }

        return $container->privates['vich_uploader.listener.clean.animal'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('animal', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
