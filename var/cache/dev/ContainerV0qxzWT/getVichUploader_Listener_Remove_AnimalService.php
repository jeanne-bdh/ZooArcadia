 ...
 */
class getVichUploader_Listener_Remove_AnimalService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.animal' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.animal'])) {
            return $container->privates['vich_uploader.listener.remove.animal'];
        }

        return $container->privates['vich_uploader.listener.remove.animal'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('animal', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
