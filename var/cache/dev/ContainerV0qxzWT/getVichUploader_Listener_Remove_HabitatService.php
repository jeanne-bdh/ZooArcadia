 ...
 */
class getVichUploader_Listener_Remove_HabitatService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.habitat' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.habitat'])) {
            return $container->privates['vich_uploader.listener.remove.habitat'];
        }

        return $container->privates['vich_uploader.listener.remove.habitat'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('habitat', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
