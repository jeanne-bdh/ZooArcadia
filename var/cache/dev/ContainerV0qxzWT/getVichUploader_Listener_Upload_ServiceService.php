 ...
 */
class getVichUploader_Listener_Upload_ServiceService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.service' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.service'])) {
            return $container->privates['vich_uploader.listener.upload.service'];
        }

        return $container->privates['vich_uploader.listener.upload.service'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('service', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
