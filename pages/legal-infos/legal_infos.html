...
<main>
    ...
    <section class="main-legal-infos">
        ...
        <p>
            ...
            numérique, les responsables du présent site internet www.Zoo Arcadia.com sont :
        </p>

        <h5>Éditeur du site</h5>
        <p>SARL Zoo Arcadia</p>
        <p>Numéro de SIREN : 123 456 789 10111</p>
        <p>Responsable éditorial : 1234 567891</p>
        <p>Téléphone : 01 23 45 67 89</p>
        <p>Email : contact@zoo-arcadia.com</p>
        <p>Site web : www.zoo-arcadia.com</p>

        <h5>Hébergement</h5>
        <p>Hébergeur : SARL Zoo Arcadia 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.Zoo Arcadia.com</p>

        <h5>Développement</h5>
        <p>SARL Zoo Arcadia 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.Zoo Arcadia.com</p>

        <h5>Conditions d’utilisation</h5>
        <p>
            Ce site www.Zoo Arcadia.com est proposé en différents langages web (HTML, HTML5, Javascript, CSS,
        ...
        <p>
            L’agence Zoo Arcadia met en œuvre tous les moyens dont elle dispose, pour assurer une information fiable et une
            mise à jour fiable de ses sites internet. Toutefois, des erreurs ou omissions peuvent survenir.
        </p>
        <p>
            L’internaute devra donc s’assurer de l’exactitude des informations auprès de l’agence Zoo Arcadia et signaler
            toutes modifications du site qu’il jugerait utile. Zoo Arcadia n’est en aucun cas responsable de l’utilisation
            faite de ces informations, et de tout préjudice direct ou indirect pouvant en découler.
        </p>

        <h5>Cookies</h5>
        <p>
            Le site www.Zoo Arcadia.com peut-être amené à vous demander l’acceptation des cookies pour des besoins
        ...
        <p>
            ...
            sur Internet. L’agence Zoo Arcadia ne dispose d’aucun moyen pour contrôler les sites en connexion avec ses
            sites internet.
        </p>
        <p>
            L’agence Zoo Arcadia ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit.
        ...
        <p>
            ...
            hyperlien en direction de www.Zoo Arcadia.com sans l’autorisation expresse et préalable de l’agence
            Zoo Arcadia.
        </p>
        <p>
            Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction d’un
            des sites internet de SARL Zoo Arcadia, il lui appartiendra d’adresser un email accessible sur le site afin de
            formuler sa demande de mise en place d’un hyperlien.
        </p>
        <p>
            La SARL Zoo Arcadia se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa
            décision.
        </p>
        ...
        <p>
            SARL Zoo Arcadia s’efforce de fournir sur le site www.Zoo Arcadia.com des informations aussi précises que
            possible. Les renseignements figurant sur le site www.Zoo Arcadia.com ne sont pas exhaustifs et les
            photos non contractuelles.
        </p>
        <p>
            Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs,
            toutes les informations indiquées sur le site www.Zoo Arcadia.com sont données à titre indicatif, et
        ...
        <p>
            ...
            signaler par courriel, à l’adresse contact@zoo-arcadia.com, en décrivant le problème de la manière la
        ...
        <p>
            ...
            présentes sur le réseau Internet ne sauraient engager la responsabilité de SARL Zoo Arcadia.
        </p>

        <h5>Propriété intellectuelle</h5>
        <p>
            Tout le contenu du présent site www.Zoo Arcadia.com, incluant, de façon non limitative, les
        ...
        <p>
            ...
            de ces différents éléments est strictement interdite sans l’accord exprès par écrit de SARL Zoo Arcadia. Cette
        ...
        <h5>Litiges</h5>
        <p>
            Les présentes conditions du site www.Zoo Arcadia.com sont régies par les lois françaises et toute
        ...
        <p>
            ...
            notre site internet www.Zoo Arcadia.com.
        </p>
