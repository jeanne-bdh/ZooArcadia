...
<main>
    ...
    <section class="main-legal-infos">
        ...
        <p>
            Bienvenue sur Zoo Arcadia, votre plateforme de covoiturage écologique. Afin d’améliorer votre expérience utilisateur, nous utilisons des cookies et autres traceurs sur notre site web. Cette page a pour but de vous informer sur leur utilisation et de vous expliquer comment vous pouvez les gérer.
        </p>
        ...
        <p>Nous utilisons plusieurs types de cookies sur Zoo Arcadia :</p>
        <ul>
            <li>
        ...
        <p>
            Lors de votre première visite sur Zoo Arcadia, un bandeau vous informe de l’utilisation des cookies et vous permet d’accepter ou de refuser certains d’entre eux. Vous pouvez également gérer vos préférences à tout moment en accédant aux paramètres des cookies depuis le bas de la page.
        ...
        <h5>5. Contact</h5>
        <p>
            Pour toute question relative à l'utilisation des cookies sur Zoo Arcadia, vous pouvez nous contacter à l’adresse suivante : contact@zoo-arcadia.com.
        </p>
